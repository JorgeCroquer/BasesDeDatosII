...
BEGIN
    ...
    WHILE VACUNAS%FOUND
        LOOP 
            INSERT INTO VACUNA_DISTRIBUIDORA VALUES (VACUNAS.id_vac, COVAX_ID, 0);      --ASIGNACION DE CADA VACUNA A COVAX CON CANTIDAD 0 (EN OTRO PROCEDURE SE ASIGNARA EL 30% DE CADA VACUNA EN EL MOMENTO QUE LLEGUE A FASE 4)
        END LOOP;
    CLOSE VACUNAS;  
