...
INSERT INTO VACUNA VALUES (DEFAULT,'Johnson and Johnson',0,91.6,9,1,'Y',-8,'Conservar entre 2 y 4 grados despues de ser descongelada.',f_fases(NULL,NULL,NULL,NULL));
INSERT INTO VACUNA VALUES (DEFAULT,'AstraZeneca',0,92,3*2,2,'Y',-8,'No aplicarse a personas con fiebre.',f_fases(NULL,NULL,NULL,NULL));
...
INSERT INTO VACUNA_DISTRIBUIDORA VALUES(1,1, 1000000000);
INSERT INTO VACUNA_DISTRIBUIDORA VALUES(2,2, 1000000000);
INSERT INTO VACUNA_DISTRIBUIDORA VALUES(3,3, 1000000000);
INSERT INTO VACUNA_DISTRIBUIDORA VALUES(4,4, 1000000000);
INSERT INTO VACUNA_DISTRIBUIDORA VALUES(5,5, 1000000000);
INSERT INTO VACUNA_DISTRIBUIDORA VALUES(6,6, 1000000000);
INSERT INTO VACUNA_DISTRIBUIDORA VALUES(7,7, 1000000000);
INSERT INTO VACUNA_DISTRIBUIDORA VALUES(8,8, 1000000000);
INSERT INTO VACUNA_DISTRIBUIDORA VALUES(9,9, 1000000000);
...
INSERT INTO PAIS VALUES (DEFAULT, DEFAULT, 'Alemania','EUR', 90, 'N', 3, 5); 
EXECUTE guarda_banderas('alemania.png',1);
INSERT INTO PAIS VALUES (DEFAULT, DEFAULT, 'Arabia Saudita','ASI', 80, 'N', 1.5, 5);
EXECUTE guarda_banderas('arabiasaudita.png',2);
INSERT INTO PAIS VALUES (DEFAULT, DEFAULT, 'Argentina','AME', 80, 'N', 2, 2);
EXECUTE guarda_banderas('argentina.png',3);
INSERT INTO PAIS VALUES (DEFAULT, DEFAULT, 'Australia','OCE', 85, 'N', 1.2, 5);
EXECUTE guarda_banderas('australia.png',4);
INSERT INTO PAIS VALUES (DEFAULT, DEFAULT, 'Brasil','AME', 85, 'N', 1.1, 3);
EXECUTE guarda_banderas('brasil.png',5);
INSERT INTO PAIS VALUES (DEFAULT, DEFAULT, 'Camerun','AFR', 70, 'N', 1.6, 2);
EXECUTE guarda_banderas('camerun.png',6);
INSERT INTO PAIS VALUES (DEFAULT, DEFAULT, 'Canadá','AME', 85, 'N', 1.3, 5);
EXECUTE guarda_banderas('canada.png',7);
INSERT INTO PAIS VALUES (DEFAULT, DEFAULT, 'China','ASI', 90, 'N', 1, 5);
EXECUTE guarda_banderas('china.png',8);
INSERT INTO PAIS VALUES (DEFAULT, DEFAULT, 'Corea del Sur','ASI', 95, 'N', 1.05, 5);
EXECUTE guarda_banderas('surcorea.png',9);
INSERT INTO PAIS VALUES (DEFAULT, DEFAULT, 'Cuba','AME', 70, 'N', 1.35, 1);
EXECUTE guarda_banderas('cuba.png',10);
INSERT INTO PAIS VALUES (DEFAULT, DEFAULT, 'Egipto','AFR', 75, 'N', 1.1, 3);
EXECUTE guarda_banderas('egipto.png',11);
INSERT INTO PAIS VALUES (DEFAULT, DEFAULT, 'El Salvador','AME', 80, 'N', 1.85, 2);
EXECUTE guarda_banderas('salvador.png',12);
INSERT INTO PAIS VALUES (DEFAULT, DEFAULT, 'España','EUR', 85, 'N', 1.24, 4);
EXECUTE guarda_banderas('espana.png',13);
INSERT INTO PAIS VALUES (DEFAULT, DEFAULT, 'Estados Unidos','AME', 90, 'N', 3.2, 5);
EXECUTE guarda_banderas('eeuu.png',14);
INSERT INTO PAIS VALUES (DEFAULT, DEFAULT, 'Francia','EUR', 85, 'N', 2.5, 5);
EXECUTE guarda_banderas('francia.png',15);
INSERT INTO PAIS VALUES (DEFAULT, DEFAULT, 'Haití','AME', 70, 'N', 1.5, 1);
EXECUTE guarda_banderas('haiti.png',16);
INSERT INTO PAIS VALUES (DEFAULT, DEFAULT, 'India','ASI', 90, 'N', 2.4, 5);
EXECUTE guarda_banderas('india.png',17);
INSERT INTO PAIS VALUES (DEFAULT, DEFAULT, 'Islandia','EUR', 95, 'N', 1.55, 5);
EXECUTE guarda_banderas('islandia.png',18);
INSERT INTO PAIS VALUES (DEFAULT, DEFAULT, 'Italia','EUR', 90, 'N', 1.15, 4);
EXECUTE guarda_banderas('italia.png',19);
INSERT INTO PAIS VALUES (DEFAULT, DEFAULT, 'Venezuela','AME', 70, 'N', 2.2, 1);
...
--Efectos secundarios
INSERT INTO EFECTO_SECUNDARIO VALUES (DEFAULT,'Fiebre', 'El paciente presenta temperatura corporal mayor a 38°',0.15);
INSERT INTO EFECTO_SECUNDARIO VALUES (DEFAULT,'Nauseas', 'El paciente presenta nauseas',0.5);
INSERT INTO EFECTO_SECUNDARIO VALUES (DEFAULT,'Dolores musculares', 'El paciente presenta dolores en los musculos',0.4);
INSERT INTO EFECTO_SECUNDARIO VALUES (DEFAULT,'Trombosis', 'El paciente presenta trombos en la sangre',0.001);

--Vac_Efec
INSERT INTO VAC_EFEC VALUES (1,1);
INSERT INTO VAC_EFEC VALUES (3,1);
INSERT INTO VAC_EFEC VALUES (1,2);
INSERT INTO VAC_EFEC VALUES (2,2);
INSERT INTO VAC_EFEC VALUES (3,2);
INSERT INTO VAC_EFEC VALUES (1,3);
INSERT INTO VAC_EFEC VALUES (2,3);
INSERT INTO VAC_EFEC VALUES (3,3);
INSERT INTO VAC_EFEC VALUES (1,4);
INSERT INTO VAC_EFEC VALUES (2,4);
INSERT INTO VAC_EFEC VALUES (3,4);
INSERT INTO VAC_EFEC VALUES (4,4);
INSERT INTO VAC_EFEC VALUES (1,5);
INSERT INTO VAC_EFEC VALUES (2,5);
INSERT INTO VAC_EFEC VALUES (3,5);
INSERT INTO VAC_EFEC VALUES (1,6);
INSERT INTO VAC_EFEC VALUES (2,6);
INSERT INTO VAC_EFEC VALUES (3,6);
INSERT INTO VAC_EFEC VALUES (1,7);
INSERT INTO VAC_EFEC VALUES (1,8);
INSERT INTO VAC_EFEC VALUES (2,8);
INSERT INTO VAC_EFEC VALUES (3,8);
INSERT INTO VAC_EFEC VALUES (1,9);
INSERT INTO VAC_EFEC VALUES (2,9);
INSERT INTO VAC_EFEC VALUES (3,9);
INSERT INTO VAC_EFEC VALUES (4,9);
